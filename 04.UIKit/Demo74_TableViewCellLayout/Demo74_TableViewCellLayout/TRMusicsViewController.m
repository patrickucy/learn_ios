...
- (void)viewDidLoad
{
	...
	self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel	target:self action:@selector(rewindToMainView)];
	
	[self.tableView registerNib:[UINib nibWithNibName:@"TRMyCell" bundle:nil] forCellReuseIdentifier:@"Cell"];
}

-(void)rewindToMainView
{
...
{
    TRMyCell *cell = [tableView dequeueReusableCellWithIdentifier:@"Cell" forIndexPath:indexPath];
    // Configure the cell...
