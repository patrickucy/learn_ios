...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	initialViewController.data = @[@"C",@"Java",@"Objective-C",@"C++",@"C#",@"PHP",
								   @"VB",@"Python",@"Transact=SQL",@"JavaScript",
								   @"VB.NET",@"Perl",@"Ruby",@"Pascal",@"Lisp",
								   @"Matlab",@"Delphi",@"PL/SQL"];
