...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	UINavigationController *naviA = [[UINavigationController alloc] initWithRootViewController:aVC];
	
	TRBViewController *bVC = [[TRBViewController alloc] initWithNibName:@"TRBViewController" bundle:nil];
	UINavigationController *naviB = [[UINavigationController alloc] initWithRootViewController:bVC];

	
	UITabBarController *tabBarController = [[UITabBarController alloc] init];
	tabBarController.viewControllers = @[naviA,naviB];
