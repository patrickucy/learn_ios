...
- (void)viewDidLoad
{
	...
	self.names = @[@"zhangsan",@"li si",@"wang wu"];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //判断有没有可以复用的 view, 没有就直接创建,有就直接用,这整个过程上面这个代码全部都做了. identifier 可以在 storyboard 里面写
    // Configure the cell...
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	[self performSegueWithIdentifier:@"segue1" sender:self.names[indexPath.row]];
}
